...
pub fn generate_title_page_markup(meta: &ScreenplayMeta) -> String {
    ...
    // `numbering: none` overrides the global page-numbering setting so the
    // title page prints without a page number (Hollywood convention).
...
#set page(paper: "a4", margin: (top: 2.5cm, bottom: 2.5cm, left: 3cm, right: 2.5cm), numbering: "1.", number-align: right + top)
...
#set page(paper: "a4", margin: (top: 2cm, bottom: 2cm, left: 1.5cm, right: 1.5cm), numbering: "1.", number-align: right + top)
...
#set page(margin: (top: 2.5cm, bottom: 2.5cm, left: 3cm, right: 3cm), numbering: "1.", number-align: right + top)
#set text(font: "{}", size: 12pt, lang: "ml", hyphenate: true)
...
#set page(margin: (top: 2.5cm, bottom: 2.5cm, left: 2.5cm, right: 2.5cm), numbering: "1.", number-align: right + top)
#set text(font: "{}", size: 11pt, lang: "ml", hyphenate: true)
