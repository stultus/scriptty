           ...
           publication's colophon. -->
			...
			<div class="credits-section">
				...
				<p class="credits-name">
					Hrishikesh Bhaskaran <span class="credits-handle">(stultus)</span>
				</p>
				<p class="credits-contact">
					<a
						href="mailto:hello@stultus.in"
						class="credits-link"
						onclick={(e) => openExternal(e, 'mailto:hello@stultus.in')}>hello@stultus.in</a
					>
					&middot;
					<a
						href="https://stultus.in"
						class="credits-link"
						onclick={(e) => openExternal(e, 'https://stultus.in')}>stultus.in</a
					>
				</p>
				<p class="credits-name with-gap">Hiran Venugopalan</p>
				<p class="credits-contact">
					<a
						href="mailto:hiran.v@gmail.com"
						class="credits-link"
						onclick={(e) => openExternal(e, 'mailto:hiran.v@gmail.com')}>hiran.v@gmail.com</a
					>
					&middot;
					<a
						href="https://hiran.in"
						class="credits-link"
						onclick={(e) => openExternal(e, 'https://hiran.in')}>hiran.in</a
					>
				</p>
				<p class="credits-name with-gap">Abraham Joseph</p>
				<p class="credits-contact">
					<a
						href="mailto:dreamingnomad@gmail.com"
						class="credits-link"
						onclick={(e) => openExternal(e, 'mailto:dreamingnomad@gmail.com')}
						>dreamingnomad@gmail.com</a
					>
				</p>
			</div>
			...
			<p class="colophon">
				Set in <em>Courier Prime</em>, <em>Manjari</em>, <em>Noto Sans Malayalam</em>, and
				<em>Fraunces</em>.
			</p>
