...
{#if visible}
	...
	>
		<button
			...
			title="Bold (⌘B)"
			aria-pressed={isBoldActive}><span class="fmt-bold">B</span></button
		>
		<button
			class="fmt-btn"
			...
			title="Italic (⌘I)"
			aria-pressed={isItalicActive}><span class="fmt-italic">I</span></button
		>
		<button
			class="fmt-btn"
			...
			title="Underline (⌘U)"
			aria-pressed={isUnderlineActive}><span class="fmt-underline">U</span></button
		>
	</div>
{/if}
