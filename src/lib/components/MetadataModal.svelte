		...
		<div class="modal-card meta-card" use:focusTrap>
			...
			{#if documentStore.isSeries}
				<div class="series-strip">
					...
					<span class="series-strip-ep"
						>Episode {documentStore.activeEpisode?.number ?? ''}{documentStore.activeEpisode?.title
					...
					<div class="form-group">
						<div class="field">
							...
							<input
								...
								placeholder={isSeries
									? "Used on this episode's title page"
									: 'e.g. The Great Screenplay'}
								required
								aria-required="true"
						...
						<div class="field">
							...
							<input
								...
								type="text"
								bind:value={tagline}
								placeholder="A one-line logline"
							/>
						</div>
					...
					<div class="form-group">
						...
						<div class="field">
							...
							<textarea
								...
								rows="2"
								bind:value={contact}
								placeholder="Bottom-left of the title page"
							></textarea>
						</div>
						...
						<div class="field">
							...
							<textarea
								...
								rows="2"
								bind:value={footnote}
								placeholder="Confidentiality line, 'based on...', dedication"
							></textarea>
						</div>
					</div>
				</section>
               ...
               screen reads as the same composition Typst produces. -->
                   ...
                   credit labels. -->
						...
						<div class="preview-bottom-left">
							...
							{#if draftNumber > 0 || formattedDraftDate}
								<div class="preview-draft">
									...
									{#if draftNumber > 0 && formattedDraftDate}<span class="preview-em-dash">
											—
										</span>{/if}
					...
					<p class="preview-note">
						Mirrors the printed cover sheet — exports use the selected document font.
					</p>
				</aside>
			</div>
			...
			<footer class="meta-footer">
				...
				<button
					...
					title={titleInvalid ? 'Title is required' : 'Save metadata'}>Save metadata</button
				>
			</footer>
		</div>
	</div>
