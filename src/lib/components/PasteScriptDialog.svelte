	...
	>
		<div class="modal-card paste-card" use:focusTrap>
			...
			<p class="hint">
				...
				<code>രമേശ്:</code>), dialogue, parentheticals, and transitions. The preview shows what was
				detected — refine in the editor after.
			</p>
...
CUT TO:`}
			...
			<div class="modal-footer">
				...
				<button class="btn-primary" onclick={handleConfirm} disabled={!parsed}
					>Open as Screenplay</button
				>
			</div>
		</div>
	</div>
