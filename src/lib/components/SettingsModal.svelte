				...
				<div class="setting-row">
					...
					<div class="segmented">
						<button
							...
							onclick={() => setLanguageMode('ENGLISH')}>English</button
						>
						<button
							class="segmented-item"
							class:active={currentMode === 'MALAYALAM'}
							onclick={() => setLanguageMode('MALAYALAM')}>മലയാളം</button
						>
					</div>
				</div>
						...
						<div class="custom-select-container">
							...
							{#if schemeDropdownOpen}
								...
								<div
									...
									onclick={(e) => {
										e.stopPropagation();
										schemeDropdownOpen = false;
									}}
									onkeydown={(e) => {
										if (e.key === 'Escape') schemeDropdownOpen = false;
									}}
								></div>
				...
				<div class="setting-row">
					...
					<div class="segmented">
						<button
							...
							onclick={() => documentStore.setFont('noto-sans-malayalam')}>Noto</button
						>
						<button
							class="segmented-item"
							class:active={documentStore.currentFont === 'manjari'}
							onclick={() => documentStore.setFont('manjari')}>Manjari</button
						>
					</div>
				</div>
				...
				<div class="setting-row">
					...
					<div class="font-size-control">
						...
						<span class="font-size-value"
							>{documentStore.activeSettings?.editor_font_size ?? 14}px</span
						>
					</div>
				</div>
				...
				<div class="setting-row">
					...
					<div class="segmented">
						<button
							...
							onclick={() => {
								if (themeStore.isDark) themeStore.toggle();
							}}>Light</button
						>
						<button
							class="segmented-item"
...
<style>
	...
	.modal-card {
       ...
       shrinks instead of clipping off-screen. */
		...
		box-shadow:
			0 12px 32px var(--shadow-heavy, rgba(0, 0, 0, 0.2)),
